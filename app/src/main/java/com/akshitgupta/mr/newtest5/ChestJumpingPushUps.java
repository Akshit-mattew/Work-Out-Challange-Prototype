...
public class ChestJumpingPushUps extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.chest_jumping_push_ups);
    ...
    public void fwd(View v) {
        ...
        if (a1.getStringExtra("excercise").contentEquals("upper")) {
            Intent b = new Intent(getApplicationContext(), Arms_Barbel_Curls.class);
