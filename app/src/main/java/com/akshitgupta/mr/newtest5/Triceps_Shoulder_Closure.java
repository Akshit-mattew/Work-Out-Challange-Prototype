...
public class Triceps_Shoulder_Closure extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.triceps__shoulder__closure);
    ...
    public void fwd(View v) {
        ...
        if (a1.getStringExtra("excercise").contentEquals("upper")) {
            Intent b = new Intent(getApplicationContext(), ForearmWristCurls.class);
