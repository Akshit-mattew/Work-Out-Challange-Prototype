...
public class Arms_Shoulder_Burpees extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.arms__bhoulder__burpees);
        ...
        Intent b = getIntent();
        if (b.getStringExtra("excercise").contentEquals("upper")) {
            tx1.setText("Upper");
        }
                            ...
                            new CountDownTimer(millInfuture, counterDownInterval) {
                                ...
                                public void onTick(long millisUntilFinished) {
...

                                    {
                                        ...
                                        image.setBackgroundResource(R.drawable.animationmynew);
    ...
    */
    ...
    public void fwd(View v) {
        ...
        if (a1.getStringExtra("excercise").contentEquals("upper")) {
            Intent b = new Intent(getApplicationContext(), Reverse_Crunch.class);
