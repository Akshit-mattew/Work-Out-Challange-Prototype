...
public class Abs_Double_Twist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.abs_double_twist);
...
TextView tx1=(TextView)findViewById(R.id.textView3);
    ...
    public void fwd(View v) {
        ...
        if (a1.getStringExtra("excercise").contentEquals("upper")) {
            Intent b = new Intent(getApplicationContext(), ChestJumpingPushUps.class);
